...
- Al hacer click en el boton de "Crear una nueva tienda" me tira un error, pero la tienda se crea igual
...
- 🟡 Por Ahora las fotos no las estoy cargando ni nada, porque no se como es el tema de los permisos de la camara o de la galeria, ademas de que no se donde guardar las fotos, si en la cache de cada App o si en alguna Db dedicada a las fotos de cada tienda y eso
...
- 🔴 Revisar un error del backend al utilizar handleAdd o handleSubstract
  - Lo pongo en Rojo porque es un error del Backend, no es de este repo, las funciones handleAdd y handleSubstract estan en perfecto estado.
